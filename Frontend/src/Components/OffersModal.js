        ...
        {terms && (
          <div className={classes.termsDiv}>
            ...
            <ul className={classes.ulTerms}>
              <li className={`${classes.termsBody} ${classes.listItem}`}>
                ...
                <a
                  ...
                  target="blank"
                  className={classes.walmartLink}
                >
                  www.walmart.com
                </a>{" "}
                or the mobile application/ mobile site thereof (collectively, ""
                <b>Walmart.com</b>"") using a credit card issued by any bank using
                EMI facility; if available on Walmart.
              </li>
              ...
              <li className={classes.termsBody}>
                ...
                credit card of any bank on Walmart and is not available on
              ...
              <li className={classes.termsBody}>
                ...
                undertake the purchase transactions on Walmart, will only pay
                ...
                on Walmart (at the time of making the purchase transactions).
              ...
              <li className={classes.termsBody}>
                ...
                <ol>
                  <li className={classes.termsBody}>
                    ...
                    participating sellers or Walmart; or
                  </li>
                  <li className={classes.termsBody}>
              ...
              <li className={classes.termsBody}>
                ...
                Walmart will not be liable for any claims on account of
                availability or non-availability of EMI facility.
              </li>
              <li className={classes.termsBody}>
                Walmart reserves the right to stop No Cost EMI payment option at
            ...
            <Typography className={`${classes.termsBody} ${classes.listItem}`}>
              ...
              using BFL EMI Card as a payment option on Walmart.
            </Typography>
            <ul className={classes.ulTerms}>
              <li className={`${classes.termsBody} ${classes.listItem}`}>
              ...
              <li className={classes.termsBody}>
                Walmart has no role to play pertaining to the Card including but
              ...
              <li className={classes.termsBody}>
                ...
                that Walmart has no role in this regard and the customers will
                not bring any claims against Walmart for any refund of any amount
                paid to BFL for such order.
              </li>
              <li className={classes.termsBody}>
                Walmart will not be held liable for any dispute arising out of or
          ...
          <ol className={classes.ol}>
            <li>
              ...
              <Typography className={classes.termsBody}>
                ...
                purchase of any eligible product listed on Walmart Between
            ...
            <li>
              ...
              <Typography className={classes.termsBody}>
                ...
                across Walmart Site and App during the offer period is
                Rs.250/card/month.
              </Typography>
            </li>
            <li>
            ...
            <li>
              ...
              <Typography className={classes.termsBody}>
                If your payment failed while placing the order, Walmart gives
          ...
          <ol className={classes.ol}>
            <li>
              <Typography className={classes.termsBody}>
                ...
                available on the website walmart or the mobile site or mobile
                application thereof (collectively, "Walmart.com") by Walmart Pay
                (India) Private Limited ("Walmart").
              </Typography>
            </li>
            <li>
              <Typography className={classes.termsBody}>
                These Offer terms and conditions ("Offer Terms") are in addition
                to the Walmart Conditions of Use & Sale and Privacy Notice to
                which you agree to by using Walmart and Terms & Conditions of
            ...
            <li>
              <Typography className={classes.termsBody}>
                ...
                extended by Walmart (in its sole discretion), without any prior
            ...
            <li>
              <Typography className={classes.termsBody}>
                ...
                “Products”) on Walmart (https://www.walmart.com) and makes
            ...
            <li>
              <Typography className={classes.termsBody}>
                ...
                seller or Walmart cancel the order and/or the Cardholder returns
            ...
            <li>
              <Typography className={classes.termsBody}>
                Walmart and/or the Bank reserve the right to disqualify the
            ...
            <li>
              <Typography className={classes.termsBody}>
                Walmart and/ or the Bank reserve the right, at any time, without
            ...
            <li>
              <Typography className={classes.termsBody}>
                Nothing herein amounts to a commitment by the Bank or Walmart to
            ...
            <li>
              <Typography className={classes.termsBody}>
                ...
                agrees that Bank and Walmart will not be liable or responsible
            ...
            <li>
              <div>
                ...
                <ol>
                  <li className={classes.termsBody}>
                    Gift Card(s) (Walmart branded and Non Walmart branded)
                  </li>
                  ...
                  <li className={classes.termsBody}>Walmart Pay balance</li>
                  <li className={classes.termsBody}>
          ...
          <ol className={classes.ol}>
            <li>
              <Typography className={classes.termsBody}>
                ...
                Solutions Limited ("<b>Bank</b>") and Walmart Pay (India) Private
                Limited (formerly known as Walmart Online Distribution Services
                Private Limited) ("<b>Walmart</b>") and made available on the
                website{" "}
                <a href="www.walmart.com" className={classes.walmartLink}>
                  www.walmart.com
                </a>{" "}
                and the mobile site and mobile application thereof
                (collectively, "<b>Walmart.com</b>").
              </Typography>
            </li>
            <li>
              <Typography className={classes.termsBody}>
                These Offer terms and conditions ("<b>Offer Terms</b>") are in
                addition to the Walmart Conditions of Use & Sale and Privacy
                Notice to which you agree to by using Walmart. In the event of
            ...
            <li>
              <Typography className={classes.termsBody}>
                ...
                from Walmart and makes the payment using the BOB Credit Card,
                ...
                on Walmart, provided the purchase value for such transaction
            ...
            <li>
              <Typography className={classes.termsBody}>
                ...
                under this Offer for the purchases on Walmart using the Card,
            ...
            <li>
              <Typography className={classes.termsBody}>
                ...
                applicable to the sale of the product(s) on Walmart. This
            ...
            <li>
              <Typography className={classes.termsBody}>
                ...
                transactions. Minimum transaction needed to avail EMI on Walmart
            ...
            <li>
              <Typography className={classes.termsBody}>
                ...
                Cardholder, seller or Walmart Seller Services Private Limited,
            ...
            <li>
              <Typography className={classes.termsBody}>
                Walmart reserves the right, at any time, without prior notice,
            ...
            <li>
              <Typography className={classes.termsBody}>
                Nothing contained herein amounts to a commitment by Walmart or
            ...
            <li>
              <Typography className={classes.termsBody}>
                ...
                resolved inter se and Walmart will not (nor will be liable or
            ...
            <li>
              <Typography className={classes.termsBody}>
                ...
                this Offer be settled in cash in lieu thereof by Walmart.
              </Typography>
            </li>
            <li>
              <Typography className={classes.termsBody}>
                By participating in this Offer, every Cardholder expressly
                agrees that Walmart or any of its affiliates will not be liable
    ...
    <div>
      ...
      <div className={classes.body}>
        <Typography className={classes.partnerHeading}>
          ...
          <a
            href="https://business.walmart.com/help/article/create-an-account/6f5b0dafd9ec41ed8fc64bb793b1e6dc"
            target="blank"
            className={classes.walmartLink}
          >
            Sign up for free
        ...
        <div className={classes.promotionTermsDiv}>
          ...
          <Typography className={classes.termsInnerHeading}>
            Walmart Business provides purchasing solutions that lets registered
            businesses shop for business supplies on Walmart.
          </Typography>
          <Typography className={classes.termsBody}>
          ...
          <ol className={classes.ol}>
            ...
            <li>
              <Typography className={classes.termsBody}>
                ...
                business account on Walmart or convert your existing personal
                account on Walmart to a business account.
              </Typography>
            </li>
            ...
            <li>
              ...
              >
                ...
                Walmart Business - FAQs
              </Typography>
            </li>
            <li>
              <Typography className={classes.termsBody}>
                To go through Walmart Business Accounts Terms and Conditions
                (T&Cs), visit: Walmart Business – T&Cs
              </Typography>
            </li>
          </ol>
        </div>
