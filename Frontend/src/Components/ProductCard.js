  ...
  return (
    ...
    >
      ...
      <div className={classes.footer}>
        ...
        <span title={"Green Score: "+ item.rating.greenScore + " out of 100"} className={classes.rating}>
        <img
          src="https://i.ibb.co/cQ7Qrxv/leaf.png"
          alt="Leaf Icon"
          style={{ width: "1.2rem", height: "1.2rem", marginRight: "0.15rem" }}
        />
        <Typography className={classes.count}>{item.rating.greenScore}</Typography>
      </span>
      </div>
